...
public class Consultas extends JDialog implements ActionListener  {
	...
	ConsultasData data = new ConsultasData(new JButton("Ver departamentos"), new JButton("Ver empleados"), new JButton("Estadisticas departamentos"), new JButton("Estadisticas empleados"), null);
